  ...
  init: function () {
    ...
    this.requires("Enemy,ship11")
      ...
      .attr({
        rotation: 180,
        y: Crafty.viewport.y,
        x: Crafty.viewport.x + Crafty.math.randomInt(this.w, Crafty.viewport.width - this.w)
      })
      .bind("EnterFrame", function () {
    ...
    console.log("KAMIZ", Crafty.viewport.x,Crafty.viewport.y, player.x, player.y, this.x, this.y)
